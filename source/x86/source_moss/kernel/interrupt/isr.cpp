...
void isr0(void) {
	ASSERT(false,"Handling divide-by-zero (stub)");
}
...
void isr2(void) {
	ASSERT(false,"Handling NMI (stub)");
}
...
void isr3(void) {
	ASSERT(false,"Handling breakpoint (stub)");
}
...
void isr4(void) {
	ASSERT(false,"Handling overflow (stub)");
}
...
void isr5(void) {
	ASSERT(false,"Handling bounds exceeded (stub)");
}
...
void isr6(void) {
	ASSERT(false,"Handling invalid opcode (stub)");
}
...
void isr7(void) {
	ASSERT(false,"Handling no math (stub)");
}
...
void isr8(ErrorCode/* error*/) {
	ASSERT(false,"Handling double-fault (stub)");
}
...
void isr10(ErrorCode/* error*/) {
	ASSERT(false,"Handling TSS (stub)");
}
...
void isr11(ErrorCode/* error*/) {
	ASSERT(false,"Handling segment (stub)");
}
...
void isr12(ErrorCode/* error*/) {
	ASSERT(false,"Handling stack (stub)");
}
...
void isr16(void) {
	ASSERT(false,"Handling FPU (stub)");
}
...
void isr17(ErrorCode/* error*/) {
	ASSERT(false,"Handling alignment (stub)");
}
...
void isr18(void) {
	ASSERT(false,"Handling machine check (stub)");
}
...
void isr19(void) {
	ASSERT(false,"Handling SIMD FPU (stub)");
}
...
bool isr34(void) {
	ASSERT(false,"Handling IRQ 2 (stub)"); return false;
}

//ISR 35 = IRQ 3 (COM2 (if enabled))
bool isr35(void) {
	ASSERT(false,"Handling IRQ 3 (stub)"); return false;
}

//ISR 36 = IRQ 4 (COM1 (if enabled))
bool isr36(void) {
	ASSERT(false,"Handling IRQ 4 (stub)"); return false;
}

//ISR 37 = IRQ 5 (LPT2 (if enabled))
bool isr37(void) {
	ASSERT(false,"Handling IRQ 5 (stub)"); return false;
}

//ISR 38 = IRQ 6 (Floppy Disk)
bool isr38(void) {
	ASSERT(false,"Handling IRQ 6 (stub)"); return false;
}

//ISR 39 = IRQ 7 (LPT1 / Unreliable "spurious" interrupt (usually))
bool isr39(void) {
	ASSERT(false,"Handling IRQ 7 (stub)"); return false;
}

//ISR 40 = IRQ 8 (CMOS real-time clock (if enabled))
bool isr40(void) {
	ASSERT(false,"Handling IRQ 8 (stub)"); return false;
}

//ISR 41 = IRQ 9 (Free for peripherals / legacy SCSI / NIC)
bool isr41(void) {
	ASSERT(false,"Handling IRQ 9 (stub)"); return false;
}

//ISR 42 = IRQ 10 (Free for peripherals / SCSI / NIC)
bool isr42(void) {
	ASSERT(false,"Handling IRQ 10 (stub)"); return false;
}

//ISR 43 = IRQ 11 (Free for peripherals / SCSI / NIC)
bool isr43(void) {
	ASSERT(false,"Handling IRQ 11 (stub)"); return false;
}
...
bool isr45(void) {
	ASSERT(false,"Handling IRQ 13 (stub)"); return false;
}
